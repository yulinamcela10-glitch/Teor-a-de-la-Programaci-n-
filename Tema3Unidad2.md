...
- **Número:** Almacena cada número ingresado.
- **Contador:** Cuenta cuántos números positivos han sido ingresados.
...
- Si **numero > 0**, aumenta el contador.
- Luego solicita al usuario un nuevo número.
- El ciclo continúa mientras el número ingresado sea mayor que 0.
...
<h3 align="center">
🖥️ <a href="Unidad2.md" style="text-decoration: none;">⬅️ Volver a la Unidad 2</a> 🖥️
</h3>
